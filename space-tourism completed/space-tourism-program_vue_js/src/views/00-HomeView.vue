...
<template>
    <div class="home-container">
        ...
        <div
            class="container max-w-[1110px] grid grid-cols-1 py-[130px] mx-auto mt-[24px] md:mt-[200px] lg:grid-cols-2">
            <div class="b-left text-white text-center max-w-[510px] mx-auto lg:text-start">
                ...
                <div class="text-preset-9 blue-300">Let’s face it; if you want to go to space, you might as well
            ...
            <router-link to="/dest" class="b-right mx-auto mt-[80px] lg:m-auto">
                <div
                    class="bg-white w-[270px] h-[270px] rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:shadow-[0_0_0_88px_rgba(255,255,255,0.1)]">
